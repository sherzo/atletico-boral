...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
    <label class="form-label">POSICIÓN ACTUAL</label>
</div>
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
    ...
    <div class="form-group">
        <div class="form-line">
            <select class="form-control" name="function" id="positions" data-toggle="tooltip" title="Seleccione solo si desea cambiar la función del atleta">
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
    <label class="form-label">EDITAR FUNCIÓN</label>
    <div class="form-group">
        <div class="form-line">
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
    ...
    <div class="form-group">
        <div class="form-line">
            <select class="form-control" name="function" id="categories" data-toggle="tooltip" title="Seleccione solo si desea cambiar de equipo al atleta">
                <option value="" disabled selected>SELECCIONE</option>
    ...
    <div class="form-group">
        <div class="form-line">        
            <select class="form-control show-tick" name="foot" >
                <option value="DIESTRO" @if($athlete->athlete->foot == 'DIESTRO') selected="" ' @endif>     DIESTRO 
                </option>
                <option value="ZURDO"  @if($athlete->athlete->foot == 'ZURDO') selected="" @endif>
                    ZURDO
                </option>
            </select>
        </div>
...
<div class="col-lg-6 col-md-6 col-sm-5 col-xs-6">
    ...
    <div class="form-group">
        <div class="form-line">
            <input type="text" class="form-control" name="soccer" style="text-transform:uppercase;" onblur="this.value = this.value.toUpperCase();" value="{{ $athlete->athlete->soccer }}" required="">
        </div>
    </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-5 col-xs-6">
    ...
    <div class="form-group">
        <div class="form-line">
            <input type="text" class="form-control" name="goalkeeper" style="text-transform:uppercase;" onblur="this.value = this.value.toUpperCase();" value="{{ $athlete->athlete->goalkeeper }}" required="">
        </div>
    </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-7 col-xs-6">
    ...
    <div class="form-group">
        <div class="form-line">
            <input type="number" min="4" class="form-control" name="age" value="{{ $athlete->athlete->age }}" required="">
        </div>
    </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-5 col-xs-6">
    ...
    <div class="form-group">
        <div class="form-line">
            <input type="text" class="form-control" name="sports" style="text-transform:uppercase;" onblur="this.value = this.value.toUpperCase();" value="{{ $athlete->athlete->sports }}" required="">
        </div>
    </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-7 col-xs-6">
    ...
    <div class="form-group">
        <div class="form-line">
            <input type="text" class="form-control" name="favorites" style="text-transform:uppercase;" onblur="this.value = this.value.toUpperCase();" value="{{ $athlete->athlete->favorites }}" required="">
        </div>
    </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
    ...
    <div class="form-group">
        <div class="form-line">
            <input type="text" class="form-control" name="fanA" style="text-transform:uppercase;" onblur="this.value = this.value.toUpperCase();" value="{{ $athlete->athlete->fanA }}" >
        </div>
    </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
    ...
    <div class="form-group">
        <div class="form-line">
            <input type="text" class="form-control" name="fanI" style="text-transform:uppercase;" onblur="this.value = this.value.toUpperCase();" value="{{ $athlete->athlete->fanI }}" required="">
        </div>
    </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-7 col-xs-6">
    ...
    <div class="form-group">
        <div class="form-line">
            <input type="text" class="form-control" name="country_team" style="text-transform:uppercase;" onblur="this.value = this.value.toUpperCase();" value="{{ $athlete->athlete->country_team }}" required="">
        </div>
    </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-5 col-xs-6">
    ...
    <div class="form-group">
        <div class="form-line">
            <input type="text" class="form-control" name="nickname" style="text-transform:uppercase;" onblur="this.value = this.value.toUpperCase();" value="{{ $athlete->athlete->nickname }}" required="">
        </div>
    </div>
</div>
<div class="col-lg-6 col-md-5 col-sm-5 col-xs-6">
    ...
    <div class="form-group">
        <div class="form-line">
            <input type="text" class="form-control" name="profession" style="text-transform:uppercase;" onblur="this.value = this.value.toUpperCase();" value="{{ $athlete->athlete->profession }}" required="">
        </div>
    </div>
</div>
<div class="col-lg-6 col-md-7 col-sm-7 col-xs-6">
    ...
    <div class="form-group">
        <div class="form-line">
            <input type="text" class="form-control" name="occupation" style="text-transform:uppercase;" onblur="this.value = this.value.toUpperCase();" value="{{ $athlete->athlete->occupation }}" required="">
        </div>
    </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-5 col-xs-4">
    ...
    <div class="form-group">
        <div class="form-line">
            <textarea rows="4" class="form-control no-resize" name="description_football" style="text-transform:uppercase;" onblur="this.value = this.value.toUpperCase();" placeholder="Por favor ingresa algo..." required="">{{ $athlete->athlete->description_football }}</textarea>
        </div>
    </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-7 col-xs-8">
    ...
    <div class="form-group">
        <div class="form-line">
            <textarea rows="4" class="form-control no-resize" name="description_like" style="text-transform:uppercase;" onblur="this.value = this.value.toUpperCase();" placeholder="Por favor ingresa algo..." required="">{{ $athlete->athlete->description_like }}</textarea>
        </div>
    </div>
</div>
