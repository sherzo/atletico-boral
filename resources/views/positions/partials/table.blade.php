            	...
            	<tr>
                    ...
                    <td class="col-lg-4 align-center">
                        <div class="btn-group" role="group" aria-label="Third group">
                            ...
                            <a href="" data-toggle="modal" data-target="#deleteTeam"><button type="button" class="btn btn-primary waves-effect"  title="Eliminar" ><i class="material-icons">delete</i></button></a>
                        </div>
                    </td>
            	</tr>
            @endforeach
